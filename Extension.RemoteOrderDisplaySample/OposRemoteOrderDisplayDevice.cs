        ...
        public class OposRemoteOrderDisplayDevice : INamedRequestHandler, IDisposable
        {
            ...
            private void Open(string peripheralName)
            {
                ...
                DeviceLockContainer.ExecuteOpos(this.asyncLock, this.remoteOrderDisplayInstanceName, OposHelper.CurrentThreadId, () =>
                {
                    ...
                    // Open
                    RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "Open");
                    this.oposRemoteOrderDisplay.Open(peripheralName);
                    OposHelper.CheckResultCode(this, this.oposRemoteOrderDisplay.ResultCode);

                    // Claim
                    RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "ClaimDevice");
                    this.oposRemoteOrderDisplay.ClaimDevice(OposHelper.ClaimTimeOut);
                    OposHelper.CheckResultCode(this, this.oposRemoteOrderDisplay.ResultCode);

                    // Enable
                    RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "DeviceEnabled = true");
            ...
            private void Close()
            {
                try
                {
                    DeviceLockContainer.ExecuteOpos(this.asyncLock, this.remoteOrderDisplayInstanceName, OposHelper.CurrentThreadId, () =>
                    {
                        ...
                        {
                            // Disabled
                            RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "DeviceEnabled = false");
                            this.oposRemoteOrderDisplay.DeviceEnabled = false;

                            // Release
                            RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "ReleaseDevice");
                            this.oposRemoteOrderDisplay.ReleaseDevice();

                            // Close
                            RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "Close");
            ...
            private void DisplayMessage(string[] data)
            {
                ...
                DeviceLockContainer.ExecuteOpos(this.asyncLock, this.remoteOrderDisplayInstanceName, OposHelper.CurrentThreadId, () =>
                {
                    ...
                    {
                        RetailLogger.Log.HardwareStationOposMethodCall(this.remoteOrderDisplayInstanceName, "DisplayMessage");
